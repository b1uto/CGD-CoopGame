...
//MODIFIED VERSION OF TRANSFORM VIEW FOR MORE ACCURATE LAG COMP
...
namespace CGD.Pun
{
    ...
    public class PhotonTransformView : MonoBehaviourPun, IPunObservable
    {
        ...
        /// <summary>
        /// Used to decide whether to continue foward trajectory.
        /// </summary>
        private double lastServerUpdate;
        ...
        public void Update()
        {
            ...
            if (!this.photonView.IsMine)
            {
                ...
                {
                    tr.position = Vector3.Lerp(tr.position, this.m_NetworkPosition, lerpSpeed * this.m_Distance * Time.deltaTime * PhotonNetwork.SerializationRate);
                    ...
                    if (tr.position == m_NetworkPosition)
                        ReachedNetworkPosition();
                }
            }
        }

        private void ReachedNetworkPosition() 
        {
            m_NetworkPosition += m_Direction * 0.5f;
        }
